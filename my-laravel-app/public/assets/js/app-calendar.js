      ...
      ${e.text}
        ...
        let S = new Calendar(w, {
            ...
            dateClick: function (info) {
                // Show the quick note popup
                Swal.fire({
                    title: "Quick Note",
                    html: `
          <form id="quickNoteForm" class="text-start">
            <div class="mb-3">
              <label class="form-label">Date</label>
              <input type="text" class="form-control" value="${info.dateStr}" disabled>
            </div>
            <div class="mb-3">
              <label class="form-label">Time</label>
              <input type="time" class="form-control" id="quickNoteTime">
            </div>
            <div class="mb-3">
              <label class="form-label">Note</label>
              <textarea class="form-control" id="quickNoteText" rows="3" placeholder="Enter your note here..."></textarea>
            </div>
            <div class="mb-3">
              <label class="form-label">Quick Status</label>
              <select class="form-select" id="quickNoteStatus">
        ...
        `,
                    ...
                    preConfirm: () => {
                        ...
                        return {
                            date: info.dateStr,
                            time: document.getElementById("quickNoteTime")
                                .value,
                            note: document.getElementById("quickNoteText")
                                .value,
                            status: document.getElementById("quickNoteStatus")
                                .value,
                        };
                    },
                }).then((result) => {
                    if (result.isConfirmed) {
                        // Here you can handle the note submission
                        // For example, send it to your server via AJAX
                        saveQuickNote(result.value);
                    }
                });
            },
