...
>
  <head>
    ...
    <title>Edit Branch - Imajica Booking System</title>
                ...
                <div class="col-12">
                  <div class="card">
                    ...
                    >
                      ...
                      <div>
                        <a href="{{ route('page.branch-list') }}" class="btn btn-sm btn-light">
                    ...
                    <div class="card-body pt-6">
                      ...
                      <div class="row">
                        ...
                        <form method="post" action="{{ route('branch.update') }}">
                            ...
                            <div class="row g-6">
                              <div class="col-md-6">
                                <label class="form-label" for="branch_code_display">Branch Code</label>
                                <input
                                  type="text"
